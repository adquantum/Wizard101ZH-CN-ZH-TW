...
rm -f ./Patch-Debug/Locale_English-Root.wad
rm -f ./Patch-Release/Locale_English-Root.wad
# 读取半汉化需要的文件列表
...
while read -r file; do
  # 执行覆盖操作
  cp -f "./Debug-Full-CN/Locale/English/${file}" "./Release-Half-CN/Locale/English/${file}"
done < "${file_list}"
# 进入Patch-Release目录
